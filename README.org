...
| =ewal-daemon-use-tty-colors=         | whether to use TTY colors when Emacs is running as a daemon                                                        |
| =ewal-use-tty-colors=                | manually set to =t= to use TTY colors everywhere                                                                   |
