  ...
  (let ((tty (if (boundp tty) tty (or wal-theme-force-tty-colors (display-graphic-p)))))
    (let ((colors (if tty wal-theme-semantic-tty-colors wal-theme-semantic-gui-colors))
      ...
      (progn
        ...
        `(shadow ((,class (:foreground ,(alist-get 'comment colors)))))
        ...
        `(helm-match ((,class (:background ,(alist-get 'highlight colors) :foreground ,(alist-get 'head1 colors)))))
        `(helm-match-item ((,class (:background ,(alist-get 'highlight colors) :foreground ,(alist-get 'head1 colors)))))
        ...
        `(org-block ((,class (:background ,(alist-get 'cblk-bg colors) :foreground ,(alist-get 'cblk colors)))))
        `(org-block-begin-line ((,class (:background ,(alist-get 'cblk-ln-bg colors) :foreground ,(alist-get 'cblk-ln colors)))))
        `(org-block-end-line ((,class (:background ,(alist-get 'cblk-ln-bg colors) :foreground ,(alist-get 'cblk-ln colors)))))
        ...
        `(org-done ((,class (:foreground ,(alist-get 'suc colors) :inherit bold :background ,(alist-get 'green-bg-s colors)))))
        ...
        `(org-link ((,class (:underline t :foreground ,(alist-get 'keyword colors)))))
        ...
        `(org-todo ((,class (:foreground ,(alist-get 'err colors) :inherit bold :background ,(alist-get 'red-bg-s colors)))))
        ...
        ;; ansi-color-names
        `(ansi-color-names-vector [,(alist-get 'bg4 colors)
                                   ,(alist-get 'red colors)
                                   ,(alist-get 'green colors)
                                   ,(alist-get 'yellow colors)
                                   ,(alist-get 'blue colors)
                                   ,(alist-get 'magenta colors)
                                   ,(alist-get 'cyan colors)
