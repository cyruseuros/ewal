...
;;;;; latex
     ...
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground (alist-get 'head3 colors) :height ,(if wal-theme-org-height 1.1 1.0) :background ,(when wal-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground (alist-get 'head4 colors) :background ,(when wal-theme-org-highlight head4-bg)))))
...
;;;;; org
     ...
     `(org-level-1 ((,class (:inherit bold :bold ,(if wal-theme-org-bold 'unspecified nil) :foreground (alist-get 'head1 colors) :height ,(if wal-theme-org-height 1.3 1.0) :background ,(when wal-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :bold ,(if wal-theme-org-bold 'unspecified nil) :foreground (alist-get 'head2 colors) :height ,(if wal-theme-org-height 1.2 1.0) :background ,(when wal-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground (alist-get 'head3 colors) :height ,(if wal-theme-org-height 1.1 1.0) :background ,(when wal-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground (alist-get 'head4 colors) :background ,(when wal-theme-org-highlight head4-bg)))))
